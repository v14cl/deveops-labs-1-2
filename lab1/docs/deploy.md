...
## Лабораторна робота №1: автоматизація через Bash
...
Підключитися до VM можна через консоль VirtualBox або SSH. Якщо SSH ще не встановлений, його можна додати окремо:
...
```bash
git clone https://github.com//devops-labs-1-2
cd devops-labs-1-2/lab1/scripts
sudo ./setup.sh
```
...
## Лабораторна робота №2: запуск через Docker Compose
